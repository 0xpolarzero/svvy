...
export const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  },
  {
    ...
    status: "shipped",
    summary:
      "Manages app-global provider keys, OAuth-backed access, web provider selection, and a General settings surface for app appearance (`system`, `light`, or `dark`) and the user's preferred external editor with backend-authoritative persistence, while leaving pi-backed agent profile configuration to the Agents pane and keeping workspace-affecting operations on explicit `workspaceId`-routed requests.",
