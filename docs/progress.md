...
- [ ] Store user-named Context Library snapshots plus durable surface bindings with resolved prompt hashes so historical sessions, handler threads, and workflow task-agent attempts remain inspectable after app restart.
